...
def initialize_params_from_file(
    ...
    start_epoch, lr, best_metric = initialize_main_xpu_model_params(
...
def initialize_main_xpu_model_params(model, weights_file, opts, reset_epoch):
    ...
    log.info('Complete initialize_main_xpu_model_params')
    return start_epoch, lr, best_metric
