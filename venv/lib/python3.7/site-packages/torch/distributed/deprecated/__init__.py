...
def init_main_worker(backend, init_method='env://', **kwargs):
    warnings.warn("""
    ================================================================================
                                        WARNING
    ================================================================================
    Main-worker mode is still experimental. The API will change without
    ...
    if _initialized:
        raise RuntimeError("trying to initialize torch.distributed.deprecated twice!")
    torch._C._dist_init_main_worker(backend, init_method, world_size,
                                      group_name, rank)
